    ...
    <div className="min-h-screen" style={{ backgroundColor: '#FFFDF6' }}>
      ...
      <div className="p-4 sm:p-6 lg:p-8 max-w-7xl mx-auto">
        ...
        <div className="mb-6 sm:mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            <h1 className="text-2xl sm:text-3xl font-bold" style={{ color: '#2E4057' }}>
        ...
        <div className="bg-white rounded-xl shadow-sm p-4 sm:p-6" style={{ backgroundColor: '#FAF6E9' }}>
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
            <h2 className="text-xl font-bold" style={{ color: '#2E4057' }}>Your Courses</h2>
            <button className="flex items-center text-sm self-start sm:self-auto" style={{ color: '#A0C878' }}>
