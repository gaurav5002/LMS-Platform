...
const ViewCourseContent = () => {
  ...
  const handleContentClick = (item, type, title, lessonKey) => {
    setSelectedContent({ type, data: item, title });

    // Mark as completed - use actual content type
    markAsCompleted(lessonKey, type);
  };
        ...
        <div className="flex items-center justify-between px-3 sm:px-4 py-3">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="relative w-16 h-16">
              ...
              <div className="absolute inset-0 flex items-center justify-center text-sm font-bold text-[#2E4057]">
                {overallProgress}%
              </div>
            </div>
          </div>
                            ...
                            {contentItems.map((item, itemIndex) => {
                              ...
                              return (
                                <button
                                  ...
                                  onClick={(e) => {
                                    e.stopPropagation()
                                    handleContentClick(item.data, item.type, item.title, item.lessonKey)
                                  }}
