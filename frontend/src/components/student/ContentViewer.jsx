...
//   console.log(selectedItem,selectedType);
//   const renderViewer = () => {
...
//               <h3 className="text-xl font-semibold text-gray-800">Now Playing: {title}</h3>
//             </div>
...
//               <h3 className="text-xl font-semibold text-gray-800">File Viewer: {title}</h3>
//             </div>
...
//                 <p className="text-gray-600 mt-2 max-w-md mx-auto">{title} will assess your understanding of key concepts</p>
//               </div>
